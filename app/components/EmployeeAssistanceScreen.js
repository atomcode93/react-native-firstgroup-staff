...
class EmployeeAssistanceScreen extends Component {
  constructor(props) {
    super(props);
    this.title = i18n.t('employeeassistance-title');
  }
  ...
  render() {
    return (
      <View style={[styles.mainContainer]}>
        ...
        <WebView
          source={{uri: encodeURI(env.app.links.perkspotUrl)}}
...
export default EmployeeAssistanceScreen;
